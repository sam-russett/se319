...
export const App = () => {
  ...
  const render_products = (ProductsCategory) => {
    ...
    return <div className='category-section fixed'>
      ...
      <button
          class="relative bg-blue-500 text-white p-3 rounded font-bold overflow-visible"
          type="button"
      ...
      <div className="m-6 p-3 mt-10 ml-0 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-6 xl:gap-x-10" style={{ maxHeight: '550px', overflowY: 'scroll' }}>
        {/* Loop Products */}
